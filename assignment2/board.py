...
class GoBoard(object):
    def __init__(self, size: int) -> None:
        ...
        self.move_history = []  # Stack to keep track of move history
    ...
    def _coord_to_point(self, row, col):
        """
        Convert coordinates to a point on the board.
        Assuming the board is a grid, and each point can be identified by a unique number.
        """
        point = (row - 1) * self.size + col
        return point
    ...
    def undo_move(self) -> None:
        ...
        if self.move_history:
            ...
            self.last2_move = last_state['last2_move']
